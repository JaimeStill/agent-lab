...
// ProjectionMap defines the structure for a database query including table, alias, and column mappings.
// It maps view property names to qualified column references (alias.column).
